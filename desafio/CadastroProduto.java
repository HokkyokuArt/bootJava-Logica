...
public class CadastroProduto {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			String nomeDeposito = null, nomeProduto = null;
			...
			do {
				ut.clear();
				System.out.println("LESGOOOO!!!\nPrimeiro, vamos dar um nome pra esse depósito:");
				System.out.println("(Digite o nome)");
				nomeDeposito = sc.next();
				...
				System.out.println("Deseja catalogar outro depósito?");
				System.out.println("(Digite 'S' para repetir ou 'N' para finalizar)");
				sim = sc.next().charAt(0);
				sim = Character.toUpperCase(sim);
